...
const PhysicianConsultationArea: React.FC<Props> = ({
    matches,
    fakeData,
}: Props) => {
    const [consultationAreaShow, setConsultationAreaShow] =
...
export default PhysicianConsultationArea
