...
import { AUDIOMETRY_PAGE } from 'constant'
...
import AudiometryExamReport from './components/exam-report'
import ButtonCard from './components/button-card'
import AddOnService from 'components/ScreeningRoom/AddOnService'

const AudiometryDetail = () => {
    ...
    return (
        <>
            <ResponsiveAppBar />
            <UserHeader />
            <ScreeningRoomInfoHeader title="AUDIOMETRY" to={AUDIOMETRY_PAGE} />
...
export default AudiometryDetail
